    ...
    <div class="secion-3">
        ...
        <article class="col-md-6 align-self-center" >
          ...
          <ul>
              ...
              <li>150 ml. de zumo de limón o lima.</li>
              <li>50 g. de cebolla morada.</li>
              <li>Sal (10 g. aproximadamente).</li>
              <li>Pimienta negra recién molida (3 g.).</li>
              <li>15 g. de apio (limpio sin telillas).</li>
              <li>Opcional: 1 toque de ají limo o rocoto (5 g. aprox.).</li>
          </ul>
        </article>
...
<p class="parrafos">Necesitarás pescado o marisco (corvina, merluza, langostinos) zumo de limón o lima, caldo de 
    pescado (fumet casero mejor que mejor), apio, cebolla morada, cilantro, sal y pimienta. Exprimimos el zumo de 
    limón o de lima (o ambos). Colamos por si queda algún pipo y pasamos al vaso de la batidora. Añadimos el pescado 
    ...
    fresco y el hielo. El hielo nos ayuda a equilibrar la acidez para evitar que el cítrico transforme el pescado del 
    cebiche. Además de ayudar a que baje la temperatura y esté frío. Trituramos hasta obtener una cremita. La textura 
    que obtengas dependerá del fumet (o caldo) que utilices. Hay quienes lo prefieren más espeso, pero lo ideal es que 
    quede con la ligereza similar a la de un zumo de limón o al agua de coco. Si queremos que pique rico le pondremos 
    un poco de ají, rocoto o guindilla, lo pondremos en la nevera durante un par de horas y lo tomaremos bien fresquito.</p>
</section>
        <section id="video" >
        <div class="container">
           <div class="row">
            <div class="col-md-6">
              <table class="table table-bordered table-info">
                ...
                <tbody>
                  <tr>
                    <th scope="row">1</th>
                    <td>V70-80 Kcal por 100 gramos calorías</td>
                    <td>15% y 20% de proteínas</td>
                  </tr>
                  <tr>
                    <th scope="row">2</th>
                    <td>120-200 Kcal por 100 gramos calorías</td>
                    <td>6 gr</td>
                  </tr>
                </tbody>
              </table>
