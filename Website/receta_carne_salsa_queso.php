...
<html lang="en">
  <head>
   ...
   <script src="https://kit.fontawesome.com/759f0e653c.js" crossorigin="anonymous"></script>
    <title>Carne en Salsa de Queso</title>
  </head>
  <body>
    <header>
...
<section class="">
    <img src="../Website/images/banner-queso-carne.jpg" class="img-fluid cerdo" alt="..." >
    <h1 class=" titulos">CARNE EN SALSA DE QUESO</h1>
</section>
<hr class=" bg-white">
<section class="container">
    ...
    <div class="secion-3">
        ...
        <article class="col-md-6 align-self-center" >
          ...
          <ul>
              <li>800 gr. de magro de cerdo.</li>
              <li>2 guindillas.</li>
              <li>1/2 taza de cacahuetes pelados.</li>
              <li>Vino tinto.</li>
        ...
        <figure class="col-md-6">
          <img src="../Website/images/queso-01.png" alt="Nuestro equipo" class="img-fluid">
        </figure>  
        </div><!-- row -->
      </div>
</section>
...
<p class="parrafos">Limpiamos los solomillos de posibles restos de pielecillas o grasa que puedan tener y cortamos en medallones 
    más bien gorditos, de 1,5 o 2 cm. de grueso. En una sartén calentamos 2 o 3 cucharadas de aceite de oliva y salteamos la carne 
    salpimentada. Yo prefiero no cocinarla demasiado ya que podría quedarse dura, continuará su cocción más adelante con la salsa.
     Reservamos. La elección de las patatas es fundamental, pues este plato quiere ir bien acompañado. Las patatas no son todas 
     iguales para freír, depende de la cantidad de almidón que contengan. En los supermercados ya venden patatas especiales para freír. 
     Os recomiendo una patata gallega a ser posible vieja, las nuevas llevan mucho almidón. Pelamos las patatas y las picamos en panadera 
     (en rodajas finas), en bastones (en tiras largas) o en cuartos, elegid el tamaño que más os guste. Hay que intentar que todas sean 
     más o menos igual, especialmente de grosor, para que se hagan por igual. Después las lavamos bien en un cuenco hasta que el agua fría 
     para quitar el almidón durante unos 5 minutos y secamos con un trapo de algodón. Reservamos.</p>
</section>
        ...
        <div class="container">
           <div class="row">
            ...
            <div class="col-md-6 embed-responsive embed-responsive-16by9">
              <iframe class="embed-responsive-item" width="560" height="315" src="https://www.youtube.com/embed/Tf0kSfx4EE0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
